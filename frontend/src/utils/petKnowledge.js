...
export const APP_FEATURES = [
  ...
  { id: 'chat_train', name: '训练中心', entry: '💬对话页 · 训练工具「🎯 训练中心」', desc: '统一入口：进入后按需选择训练模块，再进入对应配置页', how: '点「🎯 训练中心」→ 从模块卡选择 单题快练/AI 整卷出题/导入材料/错题集组卷/晨练包/每周重做 → 按需配置后开始', tips: '离线练习、锚点自测、立体图推、资料速算等仍在训练工具“快捷工具”分组；手机端不提供“真题快练”' },
